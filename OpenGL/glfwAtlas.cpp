...
int main(void)
{
    ...
    std::string textFilename = "textureAtlas.png";
    ...
    glm::vec3 topLeft1 = glm::vec3(-1, 2, 1);
    glm::vec3 topRight1 = glm::vec3(1, 2, 1);
    glm::vec3 bottomLeft1 = glm::vec3(-1, 0, 1);
    glm::vec3 bottomRight1 = glm::vec3(1, 0, 1);
    int offset = 2;
    //center square
    addTexturedTriangle(topLeft1, bottomLeft1, bottomRight1, glm::vec2(0.0f, 1.0f), glm::vec2(0.0f, 0.0f), glm::vec2(1.0f, 0.0f), triangle);
    addTexturedTriangle(topLeft1, bottomRight1, topRight1, glm::vec2(0.0f, 1.0f), glm::vec2(1.0f, 0.0f), glm::vec2(1.0f, 1.0f), triangle);
    //right square
    addTexturedTriangle(topLeft1 + glm::vec3(offset, 0, 0), bottomLeft1 + glm::vec3(offset, 0, 0), bottomRight1 + glm::vec3(offset, 0, 0), glm::vec2(0.0f, 0.5f), glm::vec2(0.0f, 0.0f), glm::vec2(0.5f, 0.0f), triangle);
    addTexturedTriangle(topLeft1 + glm::vec3(offset, 0, 0), bottomRight1 + glm::vec3(offset, 0, 0), topRight1 + glm::vec3(offset, 0, 0), glm::vec2(0.0f, 0.5f), glm::vec2(0.5f, 0.0f), glm::vec2(0.5f, 0.5f), triangle);
    //left square
    addTexturedTriangle(topLeft1 - glm::vec3(offset, 0, 0), bottomLeft1 - glm::vec3(offset, 0, 0), bottomRight1 - glm::vec3(offset, 0, 0), glm::vec2(0.0f, 1.0f), glm::vec2(0.0f, 0.5f), glm::vec2(0.5f, 0.5f), triangle);
    addTexturedTriangle(topLeft1 - glm::vec3(offset, 0, 0), bottomRight1 - glm::vec3(offset, 0, 0), topRight1 - glm::vec3(offset, 0, 0), glm::vec2(0.0f, 1.0f), glm::vec2(0.5f, 0.5), glm::vec2(0.5f, 1.0f), triangle);
    //top square
    addTexturedTriangle(topLeft1 + glm::vec3(0, offset, 0), bottomLeft1 + glm::vec3(0, offset, 0), bottomRight1 + glm::vec3(0, offset, 0), glm::vec2(0.5f, 1.0f), glm::vec2(0.5f, 0.5f), glm::vec2(1.0f, 0.5f), triangle);
    addTexturedTriangle(topLeft1 + glm::vec3(0, offset, 0), bottomRight1 + glm::vec3(0, offset, 0), topRight1 + glm::vec3(0, offset, 0), glm::vec2(0.5f, 1.0f), glm::vec2(1.0f, 0.5f), glm::vec2(1.0f, 1.0f), triangle);
    //bottom square
    addTexturedTriangle(topLeft1 - glm::vec3(0, offset, 0), bottomLeft1 - glm::vec3(0, offset, 0), bottomRight1 - glm::vec3(0, offset, 0), glm::vec2(0.5f, 0.5f), glm::vec2(0.5f, 0.0f), glm::vec2(1.0f, 0.0f), triangle);
    addTexturedTriangle(topLeft1 - glm::vec3(0, offset, 0), bottomRight1 - glm::vec3(0, offset, 0), topRight1 - glm::vec3(0, offset, 0), glm::vec2(0.5f, 0.5f), glm::vec2(1.0f, 0.0f), glm::vec2(1.0f, 0.5f), triangle);
    ...
    int shadingMode = 1;
    glm::vec4 lights[2]{
        glm::vec4(3.0f, 20.0f, 50.0f, 1.0f),
        glm::vec4(-3.0f, 20.0f, 50.0f, 1.0f)
    };
